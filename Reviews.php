...
<html>
    ...
    <body>
        ...
        <h1 style="padding-left: 600px;">Reviews</h1>
        <table border="3" style="margin-top: 30px; margin-left: 340px; margin-bottom: 30px">
            <tr>
                <th>Movie Title</th>
                <th>Picture</th>
                <th>Genre</th>
            ...
            for ($i = 0; $i < count($arrResult); $i++) {
                ...
                $movieTitle = $arrResult[$i]['movieTitle'];
                $Image=$arrResult[$i]['picture'];
                $Genre=$arrResult[$i]['movieGenre'];
                
                
                ?>
            <tr> 
                <td style="padding-right: 40px;"> <?php echo $arrResult[$i]['movieTitle']; ?></td>
                ...
                <td style="padding-right: 10px;"> <?php echo $arrResult[$i]['movieGenre']; ?></td>
                <td style="padding-right: 10px;"> <a href="doReviews.php?id=<?php echo $id; ?>">Click here</a></td>
