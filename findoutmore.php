...
$querySelect="SELECT * FROM movies WHERE movieId=$movieId";
...
<html>
    ...
    <body>
        ...
        <div style="width:350px;">
            <?php echo $movieTitle ?><br/><br/>
            Cast: <?php echo $cast ?><br/><br/>
            Director: <?php echo $director ?><br/><br/>
            Synopsis: <?php echo $synopsis ?><br/>
